      ...
      <div class="h-full  w-[50%] gap-7 border-l flex flex-col justify-center items-center">
        ...
        <div class="h-fit w-[90%]  flex flex-col justify-center items-center gap-2">
          ...
          <div class="w-[90%] flex flex-col justify-center  ">
            ...
            <input type="password" maxlength="31" class="text-black h-10 w-full shadow-2xl shadow-black rounded-xl font-mono px-2 " v-model="confirmationPass" @input="event => confirmationPass = event.target.value"/>
          </div>
        </div>
        <div class="h-fit w-full flex justify-center items-center flex-col gap-4">
          ...
          <h1>Already have an account?<span @click="show" class="text-blue-500"> Sign In</span></h1>
        </div>
      </div>
    </div>
  </div>
